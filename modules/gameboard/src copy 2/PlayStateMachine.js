    ...
    useEffect(() => {
        ...
        const fsm = new StateMachine({   
            ...
            transitions: [
                ...
                { name: 'startLevel', from: 'idle', to: 'countdown'},
                { name: 'test', from: 'countdown', to: 'idle'},
                { name: 'startCountdown', from: 'idle', to: 'countdown'},
                { name: 'beginPlay', from: ['countdown', 'idle'], to: 'play'},
                { name: 'topGoalScored', from: 'play', to: 'topGoal'},
                { name: 'bottomGoalScored', from: 'play', to: 'bottomGoal'},                
                { name: 'endScored', from: ['topGoal', 'bottomGoal'], to: 'idle'},
                { name: 'endLevel', from: ['topGoal', 'bottomGoal', 'play'], to: 'idle'},
                ...
                { name: 'endGame', from: ['play'], to: 'gameFinished' },
